...
const CACHE = 'tonmeister-7d3fb9b30e';
const ASSETS = [
  ...
  './js/miccal.js', './js/model.js', './js/palette.js', './js/quality.js', './js/reverb.js', './js/side-align.js',
  './js/side.js', './js/storage-worker.js', './js/store.js', './js/sweep.js', './js/ui/context.js',
  './js/ui/diagnostics.js', './js/ui/export.js', './js/ui/overdub.js', './js/ui/record.js', './js/ui/sessions.js',
  './js/ui/settings.js', './js/wav.js', './js/waveform.js', './js/worklets.js', './manifest.json'
];
